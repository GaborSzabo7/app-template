...
@EntityScan({ "hu.gaszabo.template.**.*", "org.springframework.data.jpa.convert.threeten" })
public class JpaConfiguration extends JpaBaseConfiguration {
	...
	protected Map<String, Object> getVendorProperties() {
		...
		map.put("eclipselink.session.customizer", "hu.gaszabo.template.infrastructure.jpa.sequence.TimeOrderedUUIDSequence");
		return map;
	}
}

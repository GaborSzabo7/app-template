package hu.gaszabo.template.infrastructure.component;

import static hu.gaszabo.template.infrastructure.util.CollectionUtil.mapWithIndex;
import static hu.gaszabo.template.infrastructure.util.StreamUtil.sequentialStream;
